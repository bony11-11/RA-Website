...
const Footer = () => {
  return (
    <footer id="contact" className="bg-dark-800 text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-6">
            <div>
              <span className="text-gold-500 font-playfair text-3xl font-bold">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-dark-700 flex items-center justify-center text-gold-500 transition-colors hover:bg-gold-500 hover:text-dark-800">
          ...
          <div>
            <h4 className="text-xl font-bold text-gold-500 mb-6">Services</h4>
            <ul className="space-y-4">
              <li>
                <a href="#" className="text-gray-400 hover:text-gold-500 transition-colors">Tent Solutions</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-gold-500 transition-colors">Shade Structures</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-gold-500 transition-colors">Parking Sheds</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-gold-500 transition-colors">Gazebo Tents</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-gold-500 transition-colors">Ramadan Tents</a>
              </li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-xl font-bold text-gold-500 mb-6">Contact</h4>
            <ul className="space-y-4">
              <li>
                <div className="flex items-start">
                  <Phone className="w-5 h-5 text-gold-500 mr-3 mt-1" />
                  <span className="text-gray-400">+971 50 123 4567</span>
                </div>
              </li>
              <li>
                <div className="flex items-start">
                  <Mail className="w-5 h-5 text-gold-500 mr-3 mt-1" />
                  <span className="text-gray-400">info@ratents.com</span>
                </div>
              </li>
              <li>
                <div className="flex items-start">
