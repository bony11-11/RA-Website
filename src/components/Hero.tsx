    ...
    <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="w-full h-full bg-cover bg-center bg-no-repeat" style={{
          backgroundImage: 'url(/lovable-uploads/1721322800607-8c38375eef04.png)',
      ...
      <div className="container relative z-20 px-6 md:px-12 text-center">
        <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="inline-block py-1 px-3 rounded-full bg-gold-500/20 text-gold-300 text-sm font-medium mb-6 border border-gold-500/30">
            Modern living spaces for contemporary lifestyles
          </div>
          
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-playfair font-bold text-white mb-6 leading-tight">
            <span className="block">
              Stylish <span className="text-gold-500">Interior</span> for
            </span>
            <span className="block">
              Modern <span className="text-gold-500">Living</span>
            </span>
          </h1>
          
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-10">
            From contemporary apartments to luxurious homes, we create exceptional living spaces tailored to your specific needs with superior craftsmanship.
          </p>
