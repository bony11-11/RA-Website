  ...
  return (
    <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div 
          className="absolute inset-0 bg-dark-900/70 backdrop-filter backdrop-blur-sm z-10"
      ...
      <div className="container relative z-20 px-6 md:px-12 text-center">
        ...
        <div 
          className={`absolute bottom-8 left-1/2 transform -translate-x-1/2 cursor-pointer animate-bounce transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}
          onClick={() => {
            document.getElementById('about')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
          }}
        >
          <div className="flex flex-col items-center">
            <span className="text-gold-500 text-sm mb-2">Scroll Down</span>
