...
const Features = () => {
  ...
  return (
    <div ref={sectionRef}>
      <ParallaxSection 
        bgImage="/lovable-uploads/f0cb1f98-919e-4095-b840-69d0bc479c82.png"
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card p-8 text-center fade-in-on-scroll hover-lift">
              ...
              <h3 className="text-xl font-bold text-gold-500 mb-4">Elegant Design</h3>
              <p className="text-gray-300">
                Our tents feature sophisticated aesthetics that elevate any event. From intricate patterns to clean lines, each design reflects luxury and refinement.
              </p>
            </div>
            ...
            <div className="glass-card p-8 text-center fade-in-on-scroll hover-lift">
              ...
              <h3 className="text-xl font-bold text-gold-500 mb-4">Customizable Features</h3>
              <p className="text-gray-300">
                Tailor your tent to your specific needs with various customization options. Choose from different sizes, colors, and additional features to make your event unique.
              </p>
            </div>
            ...
            <div className="glass-card p-8 text-center fade-in-on-scroll hover-lift">
              ...
              <h3 className="text-xl font-bold text-gold-500 mb-4">Weather Resistant</h3>
              <p className="text-gray-300">
                Our structures are engineered to withstand various weather conditions, providing your event with protection and peace of mind regardless of the elements.
              </p>
            </div>
          </div>
        </div>
